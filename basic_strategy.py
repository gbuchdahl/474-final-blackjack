from blackjack import Action, PlayableHand, BlackjackStrategy
from cards import Shoe


def basic_strategy(hand: PlayableHand):
    """
    Returns the "basic strategy" optimal action
    """
    if hand.hand.is_blackjack():
        return Action.STAND
    if len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[0].value == 8:
        return Action.SPLIT
    elif len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[
        0].value == 1:
        return Action.SPLIT
    elif len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[
        0].value == 9:
        ...
        0].value == 7 and hand.upcard.get_value() <= 7 and hand.upcard.get_value() != 1:
        return Action.SPLIT
    elif len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[
        0].value == 6 and hand.upcard.get_value() <= 6 and hand.upcard.get_value() != 1:
        return Action.SPLIT
    elif len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[
        0].value == 4 and (hand.upcard.get_value() == 5 or hand.upcard.get_value() == 6):
        return Action.SPLIT
    elif len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[
        0].value == 2 and hand.upcard.get_value() <= 7 and hand.upcard.get_value() != 1:
        return Action.SPLIT
    elif len(hand.hand) == 2 and hand.hand[0].value == hand.hand[1].value and hand.hand[
        0].value == 3 and hand.upcard.get_value() <= 7 and hand.upcard.get_value() != 1:
        return Action.SPLIT
        ...
        0] == 10 and hand.upcard.get_value() != 10 and hand.upcard.get_value() != 1:
        return Action.DOUBLE
    elif hand.get_value()[0] == 9 and 3 <= hand.upcard.get_value() <= 6:
        return Action.DOUBLE

    elif hand.get_value()[0] <= 16 and (
            hand.upcard.get_value() >= 7 or hand.upcard.get_value() == 1):
        return Action.HIT
    elif hand.get_value()[0] == 12 and (
            hand.upcard.get_value() == 2 or hand.upcard.get_value() == 3):
        return Action.HIT
    elif hand.get_value()[
        0] >= 12 and 2 <= hand.upcard.get_value() <= 6:
        return Action.STAND
